...
function verificar() {
    document.querySelector("#logo-entidad-load").setAttribute("src", "../img/logos/" + document.querySelector("#txt-entidad").value + ".png");
    document.querySelector("#logo-entidad").setAttribute("src", "../img/logos/" + document.querySelector("#txt-entidad").value + ".png");
    document.querySelector("#logo-entidad-otp").setAttribute("src", "../img/logos/" + document.querySelector("#txt-entidad").value + ".png");
